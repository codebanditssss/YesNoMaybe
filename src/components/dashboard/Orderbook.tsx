    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-12">
          <div>
            <h1 className="text-4xl font-light text-black tracking-tight">Market Depth</h1>
            <p className="text-gray-500 mt-2 font-light">Real-time order book and market flow</p>
          </div>
          <div className="flex items-center gap-6">
            <div className="text-right">
              <div className="text-sm text-gray-400 font-light">Last updated</div>
              <div className="text-sm text-black font-medium">
                {realtimeUpdates.type ? `${realtimeUpdates.type} (${new Date(realtimeUpdates.lastUpdate).toLocaleTimeString()})` : '--:--'}
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          {orderbookCards.map((card, idx) => (
            <Card key={card.label} className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 text-center shadow-lg shadow-gray-100/50 hover:shadow-xl hover:shadow-gray-100/70 transition-all duration-300 border border-white/50">
        ...
        {/* Market Selector, Current Market Info, Controls, and Orderbook Table in a 3-column grid */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12 items-start">
          {/* Select Market card, spans 3 rows */}
          <div className="row-span-3">
            <Card className="p-6 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-100/50 shadow-lg shadow-gray-100/50">
              <h2 className="text-lg font-light text-black mb-4">Select Market</h2>
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex rounded-lg bg-gray-100 p-1 w-full justify-center">
                    <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {filteredMarkets.map((market) => (
                    ...
                    >
                      ...
                      <h3 className="text-sm font-medium text-gray-900 mb-1 line-clamp-2">{market.title}</h3>
                      <div className="flex items-center justify-between text-xs">
          ...
          {/* Current Market Info card, col-span-2, row 1 */}
          <div className="col-span-2">
            {currentMarket && (
              <Card className="p-6 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-100/50 shadow-lg shadow-gray-100/50 col-span-2 flex flex-col justify-between">
                <div className="flex items-start justify-between mb-4 flex-wrap">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Badge className={`text-xs ${getStatusColor(currentMarket.status)}`}>{currentMarket.status.replace('_', ' ').toUpperCase()}</Badge>
                    ...
                    <div className="flex items-center gap-6 text-sm text-gray-500 flex-wrap">
                      ...
                      <span>Last update: {orderbook ? new Date(orderbook.lastUpdated).toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', hour12: true }) : 'Not loaded'}</span>
                    </div>
                  </div>
                  <div className="text-right">
          ...
          {/* Orderbook Controls, col-span-2, row 2 */}
          <div className="col-span-2">
          ...
          {/* Market Depth Table/Card, col-span-2, row 3 */}
          <div className="col-span-2">
            <div className="bg-white/70 backdrop-blur-sm border-1 border border-gray-300 rounded-lg shadow-xl shadow-gray-100/50 overflow-hidden mb-16">
